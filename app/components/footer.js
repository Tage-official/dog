        ...
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
              Удобный и надежный сервис для заказа услуг по выгулу собак.
          ...
          <div>
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              {lega1.map((item) => (
                <Link key={item} href="https://policies.google.com/privacy?hl=ru" className="w-full px-4 py-2 text-gray-500 rounded-md dark:text-gray-300 hover:text-indigo-500 focus:text-indigo-500 focus:bg-indigo-100 focus:outline-none dark:focus:bg-trueGray-700">      
                  {item}
                </Link>
              ))}
            </div>
          ...
          <div className="">
            ...
            <div className="flex mt-5 space-x-5 text-gray-400 dark:text-gray-500">
              ...
              <a
                href="https://www.facebook.com/ggpk/"
                target="_blank"
                rel="noopener">
              ...
              <a
                href="https://www.instagram.com/ggpk/"
                target="_blank"
                rel="noopener">
              ...
              <a
                href="https://www.linkedin.com/school/ggpkby"
                target="_blank"
                rel="noopener">
